...
urlpatterns = [
    ...
    path('article/<int:art_id>/tags/delete/<int:tag_id>',views.delete_art_tag,name='blog.delete_art_tag'),
  
    path('event/<int:id>/', views.relay, name='blog.relay'),
    path('event/<int:id>/add_check/<int:year>/<int:month>/<int:day>', views.relay_add_check, name='blog.relay_add_check'),
    path('event/<int:id>/add/<int:year>/<int:month>/<int:day>', views.relay_add, name='blog.relay_add'),
    path('event/<int:id>/edit/<int:year>/<int:month>/<int:day>', views.relay_edit, name='blog.relay_edit'),
    path('event/<int:id>/delete/<int:year>/<int:month>/<int:day>', views.relay_delete, name='blog.relay_delete'),
